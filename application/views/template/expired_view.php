            ...
            <div class="row bs-reset">
                ...
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    ...
                    <div class="login-content">
						...
						<p style="color:red;text-align:justify;">Maaf, Aplikasi tidak dapat diakses dikarenakan Masa Aktif sudah tidak berlaku. Silahkan anda hubungi Manajemen Sahabat Siswa untuk mendapatkan Kode Aktivasi.</p>
						</div>
						<h4 class="font-red font-lg bold ">Form Aktivasi<hr></h4>
						<form class="form-horizontal" method="post" action="<?=base_url();?>admin/activated" role="form">
                            ...
                            <div class="row" style="margin-bottom:10px;">
                                <div class="col-sm-6" style="margin-bottom:10px;">
									...
									<input type="input"  class="form-control "  placeholder="Kode Aktivasi" required=""  oninvalid="this.setCustomValidity('Inputkan Kode Aktivasi')" name="aktivasi" autocomplete="false" oninput="setCustomValidity('')" value="<?=$this->session->flashdata('aktivasi')?>">
									</div>
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>2018 &copy; <a href="http://www.sahabat-siswa.com/" target="_blank">SASIS</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
