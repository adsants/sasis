				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="caption">
							...
							<span class="caption-subject font-blue-sharp bold">Laporan Nilai Siswa</span>
						</div>
					</div>
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><?=$data->nm_ujian;?> </td>
											<td align='center'>
												<a href="<?=$this->template_view->base_url_admin();?>/lap_nilai/excel/?id_m_ujian=<?=$data->id_m_ujian;?>&order_by=m_siswa_paket_ujian.kelas&mapel=all" target="_blank">
													<span class="btn btn-warning"><i class="fa fa-file-excel-o"></i> 
														Export Excel Semua mata pelajaran
													</span>
												</a>
											...
											<td align='center'>
												...
												<span class="btn btn-primary" onclick="location.href='<?=$this->template_view->base_url_admin();?>/<?=$this->uri->segment('2');?>/detail/<?=$data->id_m_ujian;?>'"><i class="fa fa-book"></i> Detail Mata Pelajaran</span>
											</td>	
