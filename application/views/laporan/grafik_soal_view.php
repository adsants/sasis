				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="caption">
							...
							<span class="caption-subject font-blue-sharp bold">Analisa Butir Soal</span>
						</div>
					</div>
									...
									<tbody>
										...
										<tr>
											...
											<td align='center'>
												...
												<span class="btn btn-primary" onclick="location.href='<?=$this->template_view->base_url_admin();?>/<?=$this->uri->segment('2');?>/detail/<?=$data->id_m_ujian;?>'"><i class="fa fa-bar-chart"></i> Hasil Analisa Soal</span>
