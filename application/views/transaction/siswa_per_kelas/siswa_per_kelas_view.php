				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="caption">
							...
							<span class="caption-subject font-blue-sharp bold">Data Siswa per Kelas</span>
						</div>
					</div>
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><?=$data->nis;?> </td>
											<td><?=$data->nm_siswa;?> </td>										
											<td><?=$this->text_html->jkl($data->jkl_siswa);?> </td>
											<td align='center'>
												<?=$this->hak_akses->btn_delete($this->uri->segment('2'), 'Apakah anda yakin akan menghapus Data <b>'.$data->nm_siswa.'<b> ..?',$this->template_view->base_url_admin()."/".$this->uri->segment('2')."/delete/".$data->id_t_siswa_kelas."?".$_SERVER['QUERY_STRING'] );?>
