				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="caption">
							...
							<span class="caption-subject font-blue-sharp bold">Data Kategori User</span>
						</div>
					</div>
							...
							<div class="table-scrollable">
								<table class="table table-bordered">
									<thead>
									  <tr>
										<th >No.</th>
										<th>Kategori Pengguna Aplikasi</th>
										<th></th>
									  </tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td align='center'>
												<?=$this->hak_akses->btn_edit($this->uri->segment('2'), $this->template_view->base_url_admin()."/".$this->uri->segment('2')."/edit/".$data->id_kategori_user );?>							
												
												<?=$this->hak_akses->btn_delete($this->uri->segment('2'), 'Apakah anda yakin akan menghapus Data <b>'.$data->nm_kategori_user.'<b> ..?',$this->template_view->base_url_admin()."/".$this->uri->segment('2')."/delete/".$data->id_kategori_user );?>
