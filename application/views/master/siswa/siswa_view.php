								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><?=$data->nm_ujian;?> </td>
											<td align="center">
												<span class="btn btn-success" onclick="location.href='<?=$this->template_view->base_url_admin();?>/<?=$this->uri->segment('2');?>/detail/<?=$data->id_m_ujian;?>'"><i class="fa fa-user"></i> Data Siswa</span>
											</td>
										</tr>
										<?php
										$no++;
