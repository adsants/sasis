				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="caption">
							...
							<span class="caption-subject font-blue-sharp bold">Data Ujian</span>
						</div>
					</div>
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<!--
											<td align="center">
												<span class="btn btn-success" onclick="location.href='<?=$this->template_view->base_url_admin();?>/<?=$this->uri->segment('2');?>/siswa/<?=$data->id_m_ujian;?>'"><i class="fa fa-user"></i> Data Siswa</span>
											</td>
											-->
											<td align="center">
												<span class="btn btn-primary" onclick="location.href='<?=$this->template_view->base_url_admin();?>/<?=$this->uri->segment('2');?>/mapel/<?=$data->id_m_ujian;?>'"><i class="fa fa-book"></i> Mata Pelajaran</span>
											</td>
											<td align='center'>
												<?=$this->hak_akses->btn_edit($this->uri->segment('2'), $this->template_view->base_url_admin()."/".$this->uri->segment('2')."/edit/".$data->id_m_ujian );?>

												<?=$this->hak_akses->btn_delete($this->uri->segment('2'), 'Apakah anda yakin akan menghapus Data <b>'.$data->nm_ujian.'<b> ..?',$this->template_view->base_url_admin()."/".$this->uri->segment('2')."/delete/".$data->id_m_ujian );?>
