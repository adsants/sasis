				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="caption">
							...
							<span class="caption-subject font-blue-sharp bold">Ubah Data Paket Soal</span>
						</div>
					</div>
					...
					<div class="portlet light">
						<div class="portlet-body">
							...
							<form class="form-horizontal" method="post" action="<?=$this->template_view->base_url_admin();?>/<?=$this->uri->segment('2')?>/update/<?=$this->dataForUpdate->id_m_paket_soal;?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="form-control select2" required name="id_m_mata_pelajaran" id="id_m_mata_pelajaran" onchange="change_mapel(this.val)">
												...
												?>
												<option <?php if($this->dataForUpdate->id_m_mata_pelajaran== $data->id_m_mata_pelajaran) echo "selected";?> value="<?=$data->id_m_mata_pelajaran;?>"><?=$data->nm_mata_pelajaran;?></option>
												<?php
												}
												?>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="text" class="form-control" placeholder="Contoh : Bahasa Indonesia, Matematika" value="<?=$this->dataForUpdate->nm_paket_soal;?>" required name="nm_paket_soal">
									</div>
								</div>
