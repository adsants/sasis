				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="caption">
							...
							<span class="caption-subject font-blue-sharp bold">Tambah Data Mata Pelajaran</span>
						</div>
					</div>
						...
						<div class="portlet-body">
							...
							<form class="form-horizontal" method="post" action="<?=$this->template_view->base_url_admin();?>/<?=$this->uri->segment('2');?>/insert">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="text" class="form-control" placeholder="Contoh : Bahasa Indonesia, Matematika" value="<?=$this->session->flashdata('nm_mata_pelajaran')?>" required name="nm_mata_pelajaran">
									</div>
								</div>
